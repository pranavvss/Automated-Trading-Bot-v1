...
APIs: Yahoo Finance (yfinance) for stock data, CCXT for cryptocurrency data ```diff -(If you want to trade in forex, ill suggest ForexConnect API- Provided by OANDA)```, Alpaca API for stock trading
